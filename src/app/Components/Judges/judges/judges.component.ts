  ...
  saveAsPdf(juez: JudgesRegistered) {
    ...
    switch (this.juezActual.sede) {
      case 'El Mante':
        ...
        doc.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Reynosa':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc1.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Matamoros':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc2.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Madero':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc3.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Nuevo Laredo':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc5.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Victoria':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc6.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Estatal':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc7.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
      ...
      case 'Internacional':
        ...
        .setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc8.text(this.titlecasePipe.transform(this.juezActual.nombre), 4.2, 6.4, {align: 'center'});
